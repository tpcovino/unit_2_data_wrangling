# Data wrangling in R using Tidyverse: Programming Basics {#Programming}
...
For the following demonstration we will use the RBI data from a sample of USGS gages we used last class. First we will load the tidyverse library, everything we have done so far today is in base R.
...
test_df <- read.csv("Flashy_Dat_Subset.csv")
...
So you can do the assignment at the beginning or the end of your dplyr workings, whatever you like best.
